    ...
    <main className="flex flex-col items-center py-8 px-4 sm:p-20 md:p-24 font-sans relative text-lg md:text-xl">
      ...
      <section id="self-intro">
        ...
        <Answer>
          ...
          <br />
          UI/UX向上、コンポーネント設計、アーキテクチャ改善、コードレビューやメンバーの指導
          などに注力し、特に エラーハンドリング設計・コード品質向上
          に貢献しました。
          <br />
          <br />
          これまで培ったスキルと経験をCommunで活かしておきたいと考えております。
          <br />
          どうぞよろしくお願いいたします。 <br />
        </Answer>
      </section>
      ...
      <section id="challenging-task">
        ...
        <Answer>
          ...
          3ヶ月間は1人で新機能開発・バグ修正・パフォーマンス改善
          を担当し、納期を厳守する必要がありました。
          <br />
          このプロジェクトの<Highlight>最も大きな課題</Highlight>
          は、1人で開発のすべてを担いながら、新機能開発・デバッグ・パフォーマンス最適化のバランスを取ること
      ...
      <section id="pressure-deadline">
        ...
        <Answer>
          ...
          では、1人でフロントエンド開発を担当することになり、新機能開発・バグ修正・パフォーマンス最適化
