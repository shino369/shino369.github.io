...
export default function IndexPage({ params: { locale } }: LocaleParam) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-around p-10 sm:p-20 md:p-24">
      ...
      <DelayDiv effect="opacity" time={2500}>
        <section className="uppercase text-2xl max-w-[80vw] w-[400px] text-center flex flex-col items-center justify-around border-slate-200 border-4 rounded-xl shadow-md h-[100px] shadow-slate-400 bg-[rgba(0,0,0,0.5)] overflow-hidden">
          <ul className="w-full">
